...
async function test() {
  ...
  try {
    ...
    console.log('❌ API /auth/register ----> lỗi:', err.response?.status || err.message);
  ...
  try {
    ...
    console.log('\n❌ API /auth/login ----> lỗi:', err.response?.status || err.message);
    console.log(err.response?.data || err.message);
  }
  ...
  try {
    ...
    console.log('\n❌ API /auth/me ----> lỗi:', err.response?.status || err.message);
    console.log(err.response?.data || err.message);
  }
}
